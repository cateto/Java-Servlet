...
try{
	...
	while(rs.next()){
		...
		out.println("<input type='hidden' name='seq' value="+newSeq+">");
		...
		out.println("<td><input name='writer' readonly value='"+writer+"' size='80'/></td>");
		out.println("  </tr>");
		out.println("<tr>");
		out.println(" <td align='center'>EMAIL</td>");
		out.println(" <td><input name='email' value='"+email+"' size='80'/></td>");
		out.println(" </tr>");
		out.println("<tr>");
		out.println(" <td align='center'>SUBJECT</td>");
		out.println(" <td><input name='subject' value='"+subject+"' size='80'/></td>");
		out.println(" </tr>");
		out.println(" <tr>");
		out.println("<td align='center'>CONTENT</td>");
		out.println(" <td><textarea id='ta' name='content' rows='15' cols='60'>"+content+"</textarea></td>");
		out.println(" </tr>");
		out.println("<tr>");
